...
"""
Format for xyz files generated by ASE. The header contains cell, pbc and other
properties. Atomic forces are included.
"""
_ase_xyz = XyzFormat(
  name="ase",
...
"""
Format for xyz files generated by CP2K. The header contains steps.
"""
_cp2k = XyzFormat(
  name="cp2k",
